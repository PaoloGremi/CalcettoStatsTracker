              ...
              builder: (context, constraints) {
                ...
                return Stack(
                  ...
                  children: [
                    // Scudo grande
                    SizedBox(
                      width: maxWidth * 0.9, // 90% della larghezza disponibile
                      height: maxHeight * 0.95, // 95% dell'altezza disponibile
                      child: Image.asset(
                    ...
                    Positioned(
                      top: maxHeight *
                          -0.2, // leggermente sotto il bordo superiore dello scudo

                      child: Align(
                        //alignment: Alignment(0.5, -1), // <-- più negativo = più in alto
                        child: Transform.scale(
                          scale:
                              0.3, // <-- riduci proporzionalmente (1.0 = 100%)
                          child: Image.asset(
                    ...
                    Positioned(
                        top: maxHeight * 0.55, // leggermente sotto il bordo superiore dello scudo
                        child: Align(
                          child: 
                          FifaStats(
                            pac: 89,
  ...
  child: Container(
    ...
    decoration: BoxDecoration(
      ...
      image: const DecorationImage(
        image: AssetImage("assets/images/backgroundcity.png"), // <-- tua immagine
        fit: BoxFit.cover, // COPRE tutta l’area mantenendo proporzioni
      ),
    ),
    child: Column(
